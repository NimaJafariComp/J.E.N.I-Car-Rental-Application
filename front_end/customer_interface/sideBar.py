...
class side_bar(QWidget):
    def __init__(self):
        ...
        self.button_style = (
            "color: black; background-color: #D3D3D3; border: none; outline: none;"
        )
    ...
    def hiden_bar_setup(self):
        ...
        self.home_icon = QIcon(
            os.path.join(os.path.dirname(self.current_dir), "icons/homeicon.png")
        )
        ...
        self.table_icon = QIcon(
            os.path.join(os.path.dirname(self.current_dir), "icons/tableicon.png")
        )
    ...
    def menu_setup(self):
        ...
        self.menu_button.setStyleSheet(
            "background-color: white; border: none; outline: none;"
        )
        self.menu_icon = QIcon(
            os.path.join(os.path.dirname(self.current_dir), "icons/menuicon.png")
        )
    ...
    def setup_logo_2(self):  # set up logo img
        ...
        self.scaled_pixmap_2 = self.pixmap.scaled(
            60, 60, aspectRatioMode=1
        )  # width, height
